...
class AddPost extends Component {
    ...
    componentDidUpdate(props, state) {
        ...
        if(this.props.admin.post.id !== props.admin.post.id){
            //When Redux state Change post in admin reducer
    ...
    formats = [
        'header',
        ' ', 'italic', 'underline', 'strike', 'blockquote', 'script',
        'list', 'bullet', 'indent',
                    ...
                    <Form className={classes.container}>
                        <Paper className={classes.leftSide}>
                            ...
                            <ReactQuil
                                ...
                                placeholder="Write some cool stuf"
                        ...
                        <Paper className={classes.rightSide}>
                            ...
                            <div className={classes.saveImage}>
                            <Button 
                                variant="contained" 
                                color="secondary"
                                onClick={e => {
                            ...
                            <div>                           
                                ...
                                ><ImageIcon />Upload Post Images</Button>
